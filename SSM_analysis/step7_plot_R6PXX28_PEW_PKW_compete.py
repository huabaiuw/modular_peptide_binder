...
exp_csv  = f"{pwd}/ratio_df_Lib07_PXX28_1nM_PEW6.csv"
sort_csv = f"{pwd}/ratio_df_Lib12_PXX28_1nM_bioPEW6_10nM_PKW6.csv"
...
plt.savefig(f"{base_id}_compete_SSM_heatmap.png", dpi=300)
